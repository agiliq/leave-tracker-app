...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'UserProfile.leaves_taken'
        db.delete_column('leave_tracker_userprofile', 'leaves_taken')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'UserProfile.leaves_taken'
        raise RuntimeError("Cannot reverse this migration. 'UserProfile.leaves_taken' and its values cannot be restored.")
