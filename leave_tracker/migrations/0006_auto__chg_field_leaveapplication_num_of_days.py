...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LeaveApplication.num_of_days'
        db.alter_column('leave_tracker_leaveapplication', 'num_of_days', self.gf('django.db.models.fields.IntegerField')(default=0))

    def backwards(self, orm):

        # Changing field 'LeaveApplication.num_of_days'
        db.alter_column('leave_tracker_leaveapplication', 'num_of_days', self.gf('django.db.models.fields.IntegerField')(null=True))
