...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('leave_tracker_leaveapplication', 'end_date_new', 'end_date')
        db.rename_column('leave_tracker_leaveapplication', 'start_date_new', 'start_date')


    def backwards(self, orm):
        db.rename_column('leave_tracker_leaveapplication', 'end_date', 'end_date_new')
        db.rename_column('leave_tracker_leaveapplication', 'start_date', 'start_date_new')
