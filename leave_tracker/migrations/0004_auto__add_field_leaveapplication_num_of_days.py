...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LeaveApplication.num_of_days'
        db.add_column('leave_tracker_leaveapplication', 'num_of_days',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LeaveApplication.num_of_days'
        db.delete_column('leave_tracker_leaveapplication', 'num_of_days')
    ...
    models = {
        ...
        'leave_tracker.leaveapplication': {
            ...
            'num_of_days': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
