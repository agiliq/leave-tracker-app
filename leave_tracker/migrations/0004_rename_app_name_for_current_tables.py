...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table("tracker_leave", "leave_tracker_leave")
        db.rename_table("tracker_leaveapplication", "leave_tracker_leaveapplication")
        db.rename_table("tracker_userprofile", "leave_tracker_userprofile")
        pass

    def backwards(self, orm):
        db.rename_table("leave_tracker_leave", "tracker_leave")
        db.rename_table("leave_tracker_leaveapplication", "tracker_leaveapplication")
        db.rename_table("leave_tracker_userprofile", "tracker_userprofile")
        pass
